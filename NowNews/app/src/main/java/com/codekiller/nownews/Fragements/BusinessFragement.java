...
public class BusinessFragement extends Fragment {
    ...
    public BusinessFragement(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_business_fragement, container, false);
