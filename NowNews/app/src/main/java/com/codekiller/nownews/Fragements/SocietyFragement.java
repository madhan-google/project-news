...
public class SocietyFragement extends Fragment {
    ...
    public SocietyFragement(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_society_fragement, container, false);
