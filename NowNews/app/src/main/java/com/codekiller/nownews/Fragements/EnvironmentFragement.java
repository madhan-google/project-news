...
public class EnvironmentFragement extends Fragment {
    ...
    public EnvironmentFragement(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_environment_fragement, container, false);
