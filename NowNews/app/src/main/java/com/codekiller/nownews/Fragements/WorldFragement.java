...
public class WorldFragement extends Fragment {
    ...
    public WorldFragement(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_world_fragement, container, false);
